...
const TRANSLATIONS = {
  fr: {
    ...
    loading: "Chargement…",
    trust_delivery: "Livraison sur toute la Tunisie",
    trust_returns: "Retours faciles",
    trust_service: "Service client attentif",
    trust_wholesale: "Vente au détail et en gros",
    no_exchange: "Pas d'échange.",
    delivery_note: "Livraison sur toute la Tunisie.",
    footer_wholesale: "Vente au détail et en gros",
  ...
  en: {
    ...
    loading: "Loading…",
    trust_delivery: "Delivery across Tunisia",
    trust_returns: "Easy returns",
    trust_service: "Attentive customer service",
    trust_wholesale: "Retail & wholesale",
    no_exchange: "No exchanges.",
    delivery_note: "Delivery across Tunisia.",
    footer_wholesale: "Retail & wholesale sales",
    footer_contact_title: "Contact",
